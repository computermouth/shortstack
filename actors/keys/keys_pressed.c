...
void init_s_pressed_2();
void init_d_pressed_2();
void init_up_pressed_2();
void init_down_pressed_2();
void init_left_pressed_2();
...
void init_pressed_0(){
	...
	pressed_0.shapes[0] = esc_pressed_0;
	pressed_0.shapes[1] = ent_pressed_0;
	pressed_0.shapes[2] = w_pressed_0;
	pressed_0.shapes[3] = a_pressed_0;
	pressed_0.shapes[4] = s_pressed_0;
	pressed_0.shapes[5] = d_pressed_0;
	pressed_0.shapes[6] = up_pressed_0;
	pressed_0.shapes[7] = down_pressed_0;
	pressed_0.shapes[8] = left_pressed_0;
	pressed_0.shapes[9] = right_pressed_0;
	pressed_0.real = 10;
...
void init_pressed_1(){
	...
	pressed_1.shapes[0] = esc_pressed_1;
	pressed_1.shapes[1] = ent_pressed_1;
	pressed_1.shapes[2] = w_pressed_1;
	pressed_1.shapes[3] = a_pressed_1;
	pressed_1.shapes[4] = s_pressed_1;
	pressed_1.shapes[5] = d_pressed_1;
	pressed_1.shapes[6] = up_pressed_1;
	pressed_1.shapes[7] = down_pressed_1;
	pressed_1.shapes[8] = left_pressed_1;
	pressed_1.shapes[9] = right_pressed_1;
	pressed_1.real = 10;
...
void init_pressed_2(){
	...
	pressed_2.shapes[0] = esc_pressed_2;
	pressed_2.shapes[1] = ent_pressed_2;
	pressed_2.shapes[2] = w_pressed_2;
	pressed_2.shapes[3] = a_pressed_2;
	pressed_2.shapes[4] = s_pressed_2;
	pressed_2.shapes[5] = d_pressed_2;
	pressed_2.shapes[6] = up_pressed_2;
	pressed_2.shapes[7] = down_pressed_2;
...
void init_ent_pressed_1(){
	...
	init_shape(&ent_pressed_1, x, y, points, color, z);
...
void init_s_pressed_2(){
	...
	init_shape(&s_pressed_2, x, y, points, color, z);
...
void init_d_pressed_2(){
	...
	init_shape(&d_pressed_2, x, y, points, color, z);
...
void init_up_pressed_2(){
	...
	init_shape(&up_pressed_2, x, y, points, color, z);
...
void init_down_pressed_2(){
	...
	init_shape(&down_pressed_2, x, y, points, color, z);
...
void init_left_pressed_2(){
	...
	init_shape(&left_pressed_2, x, y, points, color, z);
